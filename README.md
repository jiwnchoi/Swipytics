...
Swipytics runs on two enviornments: [Standalone](https://jiwnchoi.github.io/Swipytics), iPython.

[Standalone](https://jiwnchoi.github.io/Swipytics) fully runs within browser engine without any installation leveraging [Pyodide](https://pyodide.org/en/stable/).
