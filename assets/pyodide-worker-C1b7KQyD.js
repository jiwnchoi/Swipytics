var Se=(e,n)=>()=>(n||e((n={exports:{}}).exports,n),n.exports);var an=Se((on,j)=>{/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */const H=Symbol("Comlink.proxy"),Ee=Symbol("Comlink.endpoint"),xe=Symbol("Comlink.releaseProxy"),C=Symbol("Comlink.finalizer"),S=Symbol("Comlink.thrown"),V=e=>typeof e=="object"&&e!==null||typeof e=="function",ke={canHandle:e=>V(e)&&e[H],serialize(e){const{port1:n,port2:a}=new MessageChannel;return $(e,n),[a,[a]]},deserialize(e){return e.start(),Ne(e)}},Oe={canHandle:e=>V(e)&&S in e,serialize({value:e}){let n;return e instanceof Error?n={isError:!0,value:{message:e.message,name:e.name,stack:e.stack}}:n={isError:!1,value:e},[n,[]]},deserialize(e){throw e.isError?Object.assign(new Error(e.value.message),e.value):e.value}},X=new Map([["proxy",ke],["throw",Oe]]);function De(e,n){for(const a of e)if(n===a||a==="*"||a instanceof RegExp&&a.test(n))return!0;return!1}function $(e,n=globalThis,a=["*"]){n.addEventListener("message",function i(s){if(!s||!s.data)return;if(!De(a,s.origin)){console.warn(`Invalid origin '${s.origin}' for comlink proxy`);return}const{id:r,type:t,path:l}=Object.assign({path:[]},s.data),o=(s.data.argumentList||[]).map(b);let f;try{const d=l.slice(0,-1).reduce((m,_)=>m[_],e),c=l.reduce((m,_)=>m[_],e);switch(t){case"GET":f=c;break;case"SET":d[l.slice(-1)[0]]=b(s.data.value),f=!0;break;case"APPLY":f=c.apply(d,o);break;case"CONSTRUCT":{const m=new c(...o);f=Re(m)}break;case"ENDPOINT":{const{port1:m,port2:_}=new MessageChannel;$(e,_),f=Ae(m,[m])}break;case"RELEASE":f=void 0;break;default:return}}catch(d){f={value:d,[S]:0}}Promise.resolve(f).catch(d=>({value:d,[S]:0})).then(d=>{const[c,m]=O(d);n.postMessage(Object.assign(Object.assign({},c),{id:r}),m),t==="RELEASE"&&(n.removeEventListener("message",i),G(n),C in e&&typeof e[C]=="function"&&e[C]())}).catch(d=>{const[c,m]=O({value:new TypeError("Unserializable return value"),[S]:0});n.postMessage(Object.assign(Object.assign({},c),{id:r}),m)})}),n.start&&n.start()}function Te(e){return e.constructor.name==="MessagePort"}function G(e){Te(e)&&e.close()}function Ne(e,n){return L(e,[],n)}function M(e){if(e)throw new Error("Proxy has been released and is not useable")}function J(e){return v(e,{type:"RELEASE"}).then(()=>{G(e)})}const x=new WeakMap,k="FinalizationRegistry"in globalThis&&new FinalizationRegistry(e=>{const n=(x.get(e)||0)-1;x.set(e,n),n===0&&J(e)});function Ce(e,n){const a=(x.get(n)||0)+1;x.set(n,a),k&&k.register(e,n,e)}function Pe(e){k&&k.unregister(e)}function L(e,n=[],a=function(){}){let i=!1;const s=new Proxy(a,{get(r,t){if(M(i),t===xe)return()=>{Pe(s),J(e),i=!0};if(t==="then"){if(n.length===0)return{then:()=>s};const l=v(e,{type:"GET",path:n.map(o=>o.toString())}).then(b);return l.then.bind(l)}return L(e,[...n,t])},set(r,t,l){M(i);const[o,f]=O(l);return v(e,{type:"SET",path:[...n,t].map(d=>d.toString()),value:o},f).then(b)},apply(r,t,l){M(i);const o=n[n.length-1];if(o===Ee)return v(e,{type:"ENDPOINT"}).then(b);if(o==="bind")return L(e,n.slice(0,-1));const[f,d]=W(l);return v(e,{type:"APPLY",path:n.map(c=>c.toString()),argumentList:f},d).then(b)},construct(r,t){M(i);const[l,o]=W(t);return v(e,{type:"CONSTRUCT",path:n.map(f=>f.toString()),argumentList:l},o).then(b)}});return Ce(s,e),s}function Le(e){return Array.prototype.concat.apply([],e)}function W(e){const n=e.map(O);return[n.map(a=>a[0]),Le(n.map(a=>a[1]))]}const Y=new WeakMap;function Ae(e,n){return Y.set(e,n),e}function Re(e){return Object.assign(e,{[H]:!0})}function O(e){for(const[n,a]of X)if(a.canHandle(e)){const[i,s]=a.serialize(e);return[{type:"HANDLER",name:n,value:i},s]}return[{type:"RAW",value:e},Y.get(e)||[]]}function b(e){switch(e.type){case"HANDLER":return X.get(e.name).deserialize(e.value);case"RAW":return e.value}}function v(e,n,a){return new Promise(i=>{const s=je();e.addEventListener("message",function r(t){!t.data||!t.data.id||t.data.id!==s||(e.removeEventListener("message",r),i(t.data))}),e.start&&e.start(),e.postMessage(Object.assign({id:s},n),a)})}function je(){return new Array(4).fill(0).map(()=>Math.floor(Math.random()*Number.MAX_SAFE_INTEGER).toString(16)).join("-")}var $e=Object.create,I=Object.defineProperty,Ie=Object.getOwnPropertyDescriptor,qe=Object.getOwnPropertyNames,ze=Object.getPrototypeOf,Be=Object.prototype.hasOwnProperty,u=(e,n)=>I(e,"name",{value:n,configurable:!0}),K=(e=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(e,{get:(n,a)=>(typeof require<"u"?require:n)[a]}):e)(function(e){if(typeof require<"u")return require.apply(this,arguments);throw new Error('Dynamic require of "'+e+'" is not supported')}),Q=(e,n)=>()=>(n||e((n={exports:{}}).exports,n),n.exports),Ue=(e,n,a,i)=>{if(n&&typeof n=="object"||typeof n=="function")for(let s of qe(n))!Be.call(e,s)&&s!==a&&I(e,s,{get:()=>n[s],enumerable:!(i=Ie(n,s))||i.enumerable});return e},We=(e,n,a)=>(a=e!=null?$e(ze(e)):{},Ue(!e||!e.__esModule?I(a,"default",{value:e,enumerable:!0}):a,e)),He=Q((e,n)=>{(function(a,i){typeof define=="function"&&define.amd?define("stackframe",[],i):typeof e=="object"?n.exports=i():a.StackFrame=i()})(e,function(){function a(p){return!isNaN(parseFloat(p))&&isFinite(p)}u(a,"_isNumber");function i(p){return p.charAt(0).toUpperCase()+p.substring(1)}u(i,"_capitalize");function s(p){return function(){return this[p]}}u(s,"_getter");var r=["isConstructor","isEval","isNative","isToplevel"],t=["columnNumber","lineNumber"],l=["fileName","functionName","source"],o=["args"],f=["evalOrigin"],d=r.concat(t,l,o,f);function c(p){if(p)for(var y=0;y<d.length;y++)p[d[y]]!==void 0&&this["set"+i(d[y])](p[d[y]])}u(c,"StackFrame"),c.prototype={getArgs:function(){return this.args},setArgs:function(p){if(Object.prototype.toString.call(p)!=="[object Array]")throw new TypeError("Args must be an Array");this.args=p},getEvalOrigin:function(){return this.evalOrigin},setEvalOrigin:function(p){if(p instanceof c)this.evalOrigin=p;else if(p instanceof Object)this.evalOrigin=new c(p);else throw new TypeError("Eval Origin must be an Object or StackFrame")},toString:function(){var p=this.getFileName()||"",y=this.getLineNumber()||"",w=this.getColumnNumber()||"",F=this.getFunctionName()||"";return this.getIsEval()?p?"[eval] ("+p+":"+y+":"+w+")":"[eval]:"+y+":"+w:F?F+" ("+p+":"+y+":"+w+")":p+":"+y+":"+w}},c.fromString=u(function(p){var y=p.indexOf("("),w=p.lastIndexOf(")"),F=p.substring(0,y),be=p.substring(y+1,w).split(","),U=p.substring(w+1);if(U.indexOf("@")===0)var N=/@(.+?)(?::(\d+))?(?::(\d+))?$/.exec(U,""),ve=N[1],Fe=N[2],Me=N[3];return new c({functionName:F,args:be||void 0,fileName:ve,lineNumber:Fe||void 0,columnNumber:Me||void 0})},"StackFrame$$fromString");for(var m=0;m<r.length;m++)c.prototype["get"+i(r[m])]=s(r[m]),c.prototype["set"+i(r[m])]=function(p){return function(y){this[p]=!!y}}(r[m]);for(var _=0;_<t.length;_++)c.prototype["get"+i(t[_])]=s(t[_]),c.prototype["set"+i(t[_])]=function(p){return function(y){if(!a(y))throw new TypeError(p+" must be a Number");this[p]=Number(y)}}(t[_]);for(var g=0;g<l.length;g++)c.prototype["get"+i(l[g])]=s(l[g]),c.prototype["set"+i(l[g])]=function(p){return function(y){this[p]=String(y)}}(l[g]);return c})}),Ve=Q((e,n)=>{(function(a,i){typeof define=="function"&&define.amd?define("error-stack-parser",["stackframe"],i):typeof e=="object"?n.exports=i(He()):a.ErrorStackParser=i(a.StackFrame)})(e,u(function(a){var i=/(^|@)\S+:\d+/,s=/^\s*at .*(\S+:\d+|\(native\))/m,r=/^(eval@)?(\[native code])?$/;return{parse:u(function(t){if(typeof t.stacktrace<"u"||typeof t["opera#sourceloc"]<"u")return this.parseOpera(t);if(t.stack&&t.stack.match(s))return this.parseV8OrIE(t);if(t.stack)return this.parseFFOrSafari(t);throw new Error("Cannot parse given Error object")},"ErrorStackParser$$parse"),extractLocation:u(function(t){if(t.indexOf(":")===-1)return[t];var l=/(.+?)(?::(\d+))?(?::(\d+))?$/,o=l.exec(t.replace(/[()]/g,""));return[o[1],o[2]||void 0,o[3]||void 0]},"ErrorStackParser$$extractLocation"),parseV8OrIE:u(function(t){var l=t.stack.split(`
`).filter(function(o){return!!o.match(s)},this);return l.map(function(o){o.indexOf("(eval ")>-1&&(o=o.replace(/eval code/g,"eval").replace(/(\(eval at [^()]*)|(,.*$)/g,""));var f=o.replace(/^\s+/,"").replace(/\(eval code/g,"(").replace(/^.*?\s+/,""),d=f.match(/ (\(.+\)$)/);f=d?f.replace(d[0],""):f;var c=this.extractLocation(d?d[1]:f),m=d&&f||void 0,_=["eval","<anonymous>"].indexOf(c[0])>-1?void 0:c[0];return new a({functionName:m,fileName:_,lineNumber:c[1],columnNumber:c[2],source:o})},this)},"ErrorStackParser$$parseV8OrIE"),parseFFOrSafari:u(function(t){var l=t.stack.split(`
`).filter(function(o){return!o.match(r)},this);return l.map(function(o){if(o.indexOf(" > eval")>-1&&(o=o.replace(/ line (\d+)(?: > eval line \d+)* > eval:\d+:\d+/g,":$1")),o.indexOf("@")===-1&&o.indexOf(":")===-1)return new a({functionName:o});var f=/((.*".+"[^@]*)?[^@]*)(?:@)/,d=o.match(f),c=d&&d[1]?d[1]:void 0,m=this.extractLocation(o.replace(f,""));return new a({functionName:c,fileName:m[0],lineNumber:m[1],columnNumber:m[2],source:o})},this)},"ErrorStackParser$$parseFFOrSafari"),parseOpera:u(function(t){return!t.stacktrace||t.message.indexOf(`
`)>-1&&t.message.split(`
...
`),f=[],d=2,c=o.length;d<c;d+=2){var m=l.exec(o[d]);m&&f.push(new a({fileName:m[2],lineNumber:m[1],source:o[d]}))}return f},"ErrorStackParser$$parseOpera9"),parseOpera10:u(function(t){for(var l=/Line (\d+).*script (?:in )?(\S+)(?:: In function (\S+))?$/i,o=t.stacktrace.split(`
`),f=[],d=0,c=o.length;d<c;d+=2){var m=l.exec(o[d]);m&&f.push(new a({functionName:m[3]||void 0,fileName:m[2],lineNumber:m[1],source:o[d]}))}return f},"ErrorStackParser$$parseOpera10"),parseOpera11:u(function(t){var l=t.stack.split(`
`).filter(function(o){return!!o.match(i)&&!o.match(/^Error created at/)},this);return l.map(function(o){var f=o.split("@"),d=this.extractLocation(f.pop()),c=f.shift()||"",m=c.replace(/<anonymous function(: (\w+))?>/,"$2").replace(/\([^)]*\)/g,"")||void 0,_;c.match(/\(([^)]*)\)/)&&(_=c.replace(/^[^(]+\(([^)]*)\)$/,"$1"));var g=_===void 0||_==="[arguments not available]"?void 0:_.split(",");return new a({functionName:m,args:g,fileName:d[0],lineNumber:d[1],columnNumber:d[2],source:o})},this)},"ErrorStackParser$$parseOpera11")}},"ErrorStackParser"))}),Xe=We(Ve()),h=typeof process=="object"&&typeof process.versions=="object"&&typeof process.versions.node=="string"&&typeof process.browser>"u",Z=h&&typeof j<"u"&&typeof j.exports<"u"&&typeof K<"u"&&typeof __dirname<"u",Ge=h&&!Z,Je=typeof Deno<"u",ee=!h&&!Je,Ye=ee&&typeof window<"u"&&typeof document<"u"&&typeof document.createElement<"u"&&typeof sessionStorage<"u",Ke=ee&&typeof importScripts<"u"&&typeof self<"u",ne,D,A,te,q,Qe=`"fetch" is not defined, maybe you're using node < 18? From Pyodide >= 0.25.0, node >= 18 is required. Older versions of Node.js may work, but it is not guaranteed or supported. Falling back to "node-fetch".`;async function z(){if(!h||(ne=(await import("./__vite-browser-external-CIEyP2s7.js")).default,q=await import("./__vite-browser-external-CIEyP2s7.js"),globalThis.fetch?D=fetch:(console.warn(Qe),D=(await import("./index-B489Fav_.js")).default),te=(await import("./__vite-browser-external-CIEyP2s7.js")).default,A=await import("./__vite-browser-external-CIEyP2s7.js"),B=A.sep,typeof K<"u"))return;let e=await import("./__vite-browser-external-CIEyP2s7.js"),n=await import("./__vite-browser-external-CIEyP2s7.js"),a=await import("./__vite-browser-external-CIEyP2s7.js"),i=await import("./__vite-browser-external-CIEyP2s7.js"),s={fs:e,crypto:n,ws:a,child_process:i};globalThis.require=function(r){return s[r]}}u(z,"initNodeModules");function ae(e,n){return A.resolve(n||".",e)}u(ae,"node_resolvePath");function re(e,n){return n===void 0&&(n=location),new URL(e,n).toString()}u(re,"browser_resolvePath");var R;h?R=ae:R=re;var B;h||(B="/");function ie(e,n){return e.startsWith("file://")&&(e=e.slice(7)),e.includes("://")?{response:D(e)}:{binary:q.readFile(e).then(a=>new Uint8Array(a.buffer,a.byteOffset,a.byteLength))}}u(ie,"node_getBinaryResponse");function oe(e,n){let a=new URL(e,location);return{response:fetch(a,n?{integrity:n}:{})}}u(oe,"browser_getBinaryResponse");var T;h?T=ie:T=oe;async function se(e,n){let{response:a,binary:i}=T(e,n);if(i)return i;let s=await a;if(!s.ok)throw new Error(`Failed to load '${e}': request failed.`);return new Uint8Array(await s.arrayBuffer())}u(se,"loadBinaryFile");var E;if(Ye)E=u(async e=>await import(e),"loadScript");else if(Ke)E=u(async e=>{try{globalThis.importScripts(e)}catch(n){if(n instanceof TypeError)await import(e);else throw n}},"loadScript");else if(h)E=le;else throw new Error("Cannot determine runtime environment");async function le(e){e.startsWith("file://")&&(e=e.slice(7)),e.includes("://")?te.runInThisContext(await(await D(e)).text()):await import(ne.pathToFileURL(e).href)}u(le,"nodeLoadScript");async function de(e){if(h){await z();let n=await q.readFile(e);return JSON.parse(n)}else return await(await fetch(e)).json()}u(de,"loadLockFile");async function fe(){if(Z)return __dirname;let e;try{throw new Error}catch(i){e=i}let n=Xe.default.parse(e)[0].fileName;if(Ge){let i=await import("./__vite-browser-external-CIEyP2s7.js");return(await import("./__vite-browser-external-CIEyP2s7.js")).fileURLToPath(i.dirname(n))}let a=n.lastIndexOf(B);if(a===-1)throw new Error("Could not extract indexURL path from pyodide module location");return n.slice(0,a)}u(fe,"calculateDirname");function ce(e){let n=e.FS,a=e.FS.filesystems.MEMFS,i=e.PATH,s={DIR_MODE:16895,FILE_MODE:33279,mount:function(r){if(!r.opts.fileSystemHandle)throw new Error("opts.fileSystemHandle is required");return a.mount.apply(null,arguments)},syncfs:async(r,t,l)=>{try{let o=s.getLocalSet(r),f=await s.getRemoteSet(r),d=t?f:o,c=t?o:f;await s.reconcile(r,d,c),l(null)}catch(o){l(o)}},getLocalSet:r=>{let t=Object.create(null);function l(d){return d!=="."&&d!==".."}u(l,"isRealDir");function o(d){return c=>i.join2(d,c)}u(o,"toAbsolute");let f=n.readdir(r.mountpoint).filter(l).map(o(r.mountpoint));for(;f.length;){let d=f.pop(),c=n.stat(d);n.isDir(c.mode)&&f.push.apply(f,n.readdir(d).filter(l).map(o(d))),t[d]={timestamp:c.mtime,mode:c.mode}}return{type:"local",entries:t}},getRemoteSet:async r=>{let t=Object.create(null),l=await Ze(r.opts.fileSystemHandle);for(let[o,f]of l)o!=="."&&(t[i.join2(r.mountpoint,o)]={timestamp:f.kind==="file"?(await f.getFile()).lastModifiedDate:new Date,mode:f.kind==="file"?s.FILE_MODE:s.DIR_MODE});return{type:"remote",entries:t,handles:l}},loadLocalEntry:r=>{let t=n.lookupPath(r).node,l=n.stat(r);if(n.isDir(l.mode))return{timestamp:l.mtime,mode:l.mode};if(n.isFile(l.mode))return t.contents=a.getFileDataAsTypedArray(t),{timestamp:l.mtime,mode:l.mode,contents:t.contents};throw new Error("node type not supported")},storeLocalEntry:(r,t)=>{if(n.isDir(t.mode))n.mkdirTree(r,t.mode);else if(n.isFile(t.mode))n.writeFile(r,t.contents,{canOwn:!0});else throw new Error("node type not supported");n.chmod(r,t.mode),n.utime(r,t.timestamp,t.timestamp)},removeLocalEntry:r=>{var t=n.stat(r);n.isDir(t.mode)?n.rmdir(r):n.isFile(t.mode)&&n.unlink(r)},loadRemoteEntry:async r=>{if(r.kind==="file"){let t=await r.getFile();return{contents:new Uint8Array(await t.arrayBuffer()),mode:s.FILE_MODE,timestamp:t.lastModifiedDate}}else{if(r.kind==="directory")return{mode:s.DIR_MODE,timestamp:new Date};throw new Error("unknown kind: "+r.kind)}},storeRemoteEntry:async(r,t,l)=>{let o=r.get(i.dirname(t)),f=n.isFile(l.mode)?await o.getFileHandle(i.basename(t),{create:!0}):await o.getDirectoryHandle(i.basename(t),{create:!0});if(f.kind==="file"){let d=await f.createWritable();await d.write(l.contents),await d.close()}r.set(t,f)},removeRemoteEntry:async(r,t)=>{await r.get(i.dirname(t)).removeEntry(i.basename(t)),r.delete(t)},reconcile:async(r,t,l)=>{let o=0,f=[];Object.keys(t.entries).forEach(function(m){let _=t.entries[m],g=l.entries[m];(!g||n.isFile(_.mode)&&_.timestamp.getTime()>g.timestamp.getTime())&&(f.push(m),o++)}),f.sort();let d=[];if(Object.keys(l.entries).forEach(function(m){t.entries[m]||(d.push(m),o++)}),d.sort().reverse(),!o)return;let c=t.type==="remote"?t.handles:l.handles;for(let m of f){let _=i.normalize(m.replace(r.mountpoint,"/")).substring(1);if(l.type==="local"){let g=c.get(_),p=await s.loadRemoteEntry(g);s.storeLocalEntry(m,p)}else{let g=s.loadLocalEntry(m);await s.storeRemoteEntry(c,_,g)}}for(let m of d)if(l.type==="local")s.removeLocalEntry(m);else{let _=i.normalize(m.replace(r.mountpoint,"/")).substring(1);await s.removeRemoteEntry(c,_)}}};e.FS.filesystems.NATIVEFS_ASYNC=s}u(ce,"initializeNativeFS");var Ze=u(async e=>{let n=[];async function a(s){for await(let r of s.values())n.push(r),r.kind==="directory"&&await a(r)}u(a,"collect"),await a(e);let i=new Map;i.set(".",e);for(let s of n){let r=(await e.resolve(s)).join("/");i.set(r,s)}return i},"getFsHandles");function me(){let e={};return e.noImageDecoding=!0,e.noAudioDecoding=!0,e.noWasmDecoding=!1,e.preRun=[],e.quit=(n,a)=>{throw e.exited={status:n,toThrow:a},a},e}u(me,"createModule");function pe(e,n){e.preRun.push(function(){let a="/";try{e.FS.mkdirTree(n)}catch(i){console.error(`Error occurred while making a home directory '${n}':`),console.error(i),console.error(`Using '${a}' for a home directory instead`),n=a}e.FS.chdir(n)})}u(pe,"createHomeDirectory");function ue(e,n){e.preRun.push(function(){Object.assign(e.ENV,n)})}u(ue,"setEnvironment");function _e(e,n){e.preRun.push(()=>{for(let a of n)e.FS.mkdirTree(a),e.FS.mount(e.FS.filesystems.NODEFS,{root:a},a)})}u(_e,"mountLocalDirectories");function ye(e,n){let a=se(n);e.preRun.push(()=>{let i=e._py_version_major(),s=e._py_version_minor();e.FS.mkdirTree("/lib"),e.FS.mkdirTree(`/lib/python${i}.${s}/site-packages`),e.addRunDependency("install-stdlib"),a.then(r=>{e.FS.writeFile(`/lib/python${i}${s}.zip`,r)}).catch(r=>{console.error("Error occurred while installing the standard library:"),console.error(r)}).finally(()=>{e.removeRunDependency("install-stdlib")})})}u(ye,"installStdlib");function ge(e,n){let a;n.stdLibURL!=null?a=n.stdLibURL:a=n.indexURL+"python_stdlib.zip",ye(e,a),pe(e,n.env.HOME),ue(e,n.env),_e(e,n._node_mounts),e.preRun.push(()=>ce(e))}u(ge,"initializeFileSystem");function he(e,n){let{binary:a,response:i}=T(n+"pyodide.asm.wasm");e.instantiateWasm=function(s,r){return async function(){try{let t;i?t=await WebAssembly.instantiateStreaming(i,s):t=await WebAssembly.instantiate(await a,s);let{instance:l,module:o}=t;typeof WasmOffsetConverter<"u"&&(wasmOffsetConverter=new WasmOffsetConverter(wasmBinary,o)),r(l,o)}catch(t){console.warn("wasm instantiation failed!"),console.warn(t)}}(),{}}}u(he,"preloadWasm");var P="0.25.0";async function we(e={}){await z();let n=e.indexURL||await fe();n=R(n),n.endsWith("/")||(n+="/"),e.indexURL=n;let a={fullStdLib:!1,jsglobals:globalThis,stdin:globalThis.prompt?globalThis.prompt:void 0,lockFileURL:n+"pyodide-lock.json",args:[],_node_mounts:[],env:{},packageCacheDir:n,packages:[]},i=Object.assign(a,e);i.env.HOME||(i.env.HOME="/home/pyodide");let s=me();s.print=i.stdout,s.printErr=i.stderr,s.arguments=i.args;let r={config:i};s.API=r,r.lockFilePromise=de(i.lockFileURL),he(s,n),ge(s,i);let t=new Promise(o=>s.postRun=o);if(s.locateFile=o=>i.indexURL+o,typeof _createPyodideModule!="function"){let o=`${i.indexURL}pyodide.asm.js`;await E(o)}if(await _createPyodideModule(s),await t,s.exited)throw s.exited.toThrow;if(e.pyproxyToStringRepr&&r.setPyProxyToStringMethod(!0),r.version!==P)throw new Error(`Pyodide version does not match: '${P}' <==> '${r.version}'. If you updated the Pyodide version, make sure you also updated the 'indexURL' parameter passed to loadPyodide.`);s.locateFile=o=>{throw new Error("Didn't expect to load any more file_packager files!")};let l=r.finalizeBootstrap();if(l.version.includes("dev")||r.setCdnUrl(`https://cdn.jsdelivr.net/pyodide/v${l.version}/full/`),await r.packageIndexReady,r._pyodide._importhook.register_module_not_found_hook(r._import_name_to_package_name,r.lockfile_unvendored_stdlibs_and_test),r.lockfile_info.version!==P)throw new Error("Lock file version doesn't match Pyodide version");return r.package_loader.init_loaded_packages(),i.fullStdLib&&await l.loadPackage(r.lockfile_unvendored_stdlibs),r.initializeStreams(i.stdin,i.stdout,i.stderr),l}u(we,"loadPyodide");async function en(e){const n={"api/app.py":`from __future__ import annotations
...
`};for(const[a,i]of Object.entries(n)){const s=a.split("/").slice(0,-1);let r="";for(const t of s){r=r?`${r}/${t}`:t;try{e.FS.mkdir(r)}catch{}}e.FS.writeFile(a,i)}}async function nn(e){await e.runPythonAsync(`from __future__ import annotations
