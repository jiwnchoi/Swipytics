...
`).filter(function(s){return!s.match(r)},this);return l.map(function(s){if(s.indexOf(" > eval")>-1&&(s=s.replace(/ line (\d+)(?: > eval line \d+)* > eval:\d+:\d+/g,":$1")),s.indexOf("@")===-1&&s.indexOf(":")===-1)return new i({functionName:s});var c=/((.*".+"[^@]*)?[^@]*)(?:@)/,d=s.match(c),f=d&&d[1]?d[1]:void 0,m=this.extractLocation(s.replace(c,""));return new i({functionName:f,fileName:m[0],lineNumber:m[1],columnNumber:m[2],source:s})},this)},"ErrorStackParser$$parseFFOrSafari"),parseOpera:_(function(t){return!t.stacktrace||t.message.indexOf(`
`)>-1&&t.message.split(`
