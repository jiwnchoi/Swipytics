 ...
 */const H=Symbol("Comlink.proxy"),Se=Symbol("Comlink.endpoint"),xe=Symbol("Comlink.releaseProxy"),P=Symbol("Comlink.finalizer"),E=Symbol("Comlink.thrown"),V=e=>typeof e=="object"&&e!==null||typeof e=="function",ke={canHandle:e=>V(e)&&e[H],serialize(e){const{port1:n,port2:r}=new MessageChannel;return $(e,n),[r,[r]]},deserialize(e){return e.start(),Ce(e)}},Oe={canHandle:e=>V(e)&&E in e,serialize({value:e}){let n;return e instanceof Error?n={isError:!0,value:{message:e.message,name:e.name,stack:e.stack}}:n={isError:!1,value:e},[n,[]]},deserialize(e){throw e.isError?Object.assign(new Error(e.value.message),e.value):e.value}},G=new Map([["proxy",ke],["throw",Oe]]);function De(e,n){for(const r of e)if(n===r||r==="*"||r instanceof RegExp&&r.test(n))return!0;return!1}function $(e,n=globalThis,r=["*"]){n.addEventListener("message",function a(s){if(!s||!s.data)return;if(!De(r,s.origin)){console.warn(`Invalid origin '${s.origin}' for comlink proxy`);return}const{id:i,type:t,path:l}=Object.assign({path:[]},s.data),o=(s.data.argumentList||[]).map(b);let f;try{const d=l.slice(0,-1).reduce((m,_)=>m[_],e),c=l.reduce((m,_)=>m[_],e);switch(t){case"GET":f=c;break;case"SET":d[l.slice(-1)[0]]=b(s.data.value),f=!0;break;case"APPLY":f=c.apply(d,o);break;case"CONSTRUCT":{const m=new c(...o);f=Ae(m)}break;case"ENDPOINT":{const{port1:m,port2:_}=new MessageChannel;$(e,_),f=Re(m,[m])}break;case"RELEASE":f=void 0;break;default:return}}catch(d){f={value:d,[E]:0}}Promise.resolve(f).catch(d=>({value:d,[E]:0})).then(d=>{const[c,m]=O(d);n.postMessage(Object.assign(Object.assign({},c),{id:i}),m),t==="RELEASE"&&(n.removeEventListener("message",a),J(n),P in e&&typeof e[P]=="function"&&e[P]())}).catch(d=>{const[c,m]=O({value:new TypeError("Unserializable return value"),[E]:0});n.postMessage(Object.assign(Object.assign({},c),{id:i}),m)})}),n.start&&n.start()}function Te(e){return e.constructor.name==="MessagePort"}function J(e){Te(e)&&e.close()}function Ce(e,n){return L(e,[],n)}function M(e){if(e)throw new Error("Proxy has been released and is not useable")}function Y(e){return v(e,{type:"RELEASE"}).then(()=>{J(e)})}const x=new WeakMap,k="FinalizationRegistry"in globalThis&&new FinalizationRegistry(e=>{const n=(x.get(e)||0)-1;x.set(e,n),n===0&&Y(e)});function Pe(e,n){const r=(x.get(n)||0)+1;x.set(n,r),k&&k.register(e,n,e)}function Ne(e){k&&k.unregister(e)}function L(e,n=[],r=function(){}){let a=!1;const s=new Proxy(r,{get(i,t){if(M(a),t===xe)return()=>{Ne(s),Y(e),a=!0};if(t==="then"){if(n.length===0)return{then:()=>s};const l=v(e,{type:"GET",path:n.map(o=>o.toString())}).then(b);return l.then.bind(l)}return L(e,[...n,t])},set(i,t,l){M(a);const[o,f]=O(l);return v(e,{type:"SET",path:[...n,t].map(d=>d.toString()),value:o},f).then(b)},apply(i,t,l){M(a);const o=n[n.length-1];if(o===Se)return v(e,{type:"ENDPOINT"}).then(b);if(o==="bind")return L(e,n.slice(0,-1));const[f,d]=W(l);return v(e,{type:"APPLY",path:n.map(c=>c.toString()),argumentList:f},d).then(b)},construct(i,t){M(a);const[l,o]=W(t);return v(e,{type:"CONSTRUCT",path:n.map(f=>f.toString()),argumentList:l},o).then(b)}});return Pe(s,e),s}function Le(e){return Array.prototype.concat.apply([],e)}function W(e){const n=e.map(O);return[n.map(r=>r[0]),Le(n.map(r=>r[1]))]}const K=new WeakMap;function Re(e,n){return K.set(e,n),e}function Ae(e){return Object.assign(e,{[H]:!0})}function O(e){for(const[n,r]of G)if(r.canHandle(e)){const[a,s]=r.serialize(e);return[{type:"HANDLER",name:n,value:a},s]}return[{type:"RAW",value:e},K.get(e)||[]]}function b(e){switch(e.type){case"HANDLER":return G.get(e.name).deserialize(e.value);case"RAW":return e.value}}function v(e,n,r){return new Promise(a=>{const s=je();e.addEventListener("message",function i(t){!t.data||!t.data.id||t.data.id!==s||(e.removeEventListener("message",i),a(t.data))}),e.start&&e.start(),e.postMessage(Object.assign({id:s},n),r)})}function je(){return new Array(4).fill(0).map(()=>Math.floor(Math.random()*Number.MAX_SAFE_INTEGER).toString(16)).join("-")}var $e=Object.create,z=Object.defineProperty,ze=Object.getOwnPropertyDescriptor,Ie=Object.getOwnPropertyNames,qe=Object.getPrototypeOf,Ue=Object.prototype.hasOwnProperty,p=(e,n)=>z(e,"name",{value:n,configurable:!0}),X=(e=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(e,{get:(n,r)=>(typeof require<"u"?require:n)[r]}):e)(function(e){if(typeof require<"u")return require.apply(this,arguments);throw new Error('Dynamic require of "'+e+'" is not supported')}),Q=(e,n)=>()=>(n||e((n={exports:{}}).exports,n),n.exports),Be=(e,n,r,a)=>{if(n&&typeof n=="object"||typeof n=="function")for(let s of Ie(n))!Ue.call(e,s)&&s!==r&&z(e,s,{get:()=>n[s],enumerable:!(a=ze(n,s))||a.enumerable});return e},We=(e,n,r)=>(r=e!=null?$e(qe(e)):{},Be(!e||!e.__esModule?z(r,"default",{value:e,enumerable:!0}):r,e)),He=Q((e,n)=>{(function(r,a){typeof define=="function"&&define.amd?define("stackframe",[],a):typeof e=="object"?n.exports=a():r.StackFrame=a()})(e,function(){function r(u){return!isNaN(parseFloat(u))&&isFinite(u)}p(r,"_isNumber");function a(u){return u.charAt(0).toUpperCase()+u.substring(1)}p(a,"_capitalize");function s(u){return function(){return this[u]}}p(s,"_getter");var i=["isConstructor","isEval","isNative","isToplevel"],t=["columnNumber","lineNumber"],l=["fileName","functionName","source"],o=["args"],f=["evalOrigin"],d=i.concat(t,l,o,f);function c(u){if(u)for(var g=0;g<d.length;g++)u[d[g]]!==void 0&&this["set"+a(d[g])](u[d[g]])}p(c,"StackFrame"),c.prototype={getArgs:function(){return this.args},setArgs:function(u){if(Object.prototype.toString.call(u)!=="[object Array]")throw new TypeError("Args must be an Array");this.args=u},getEvalOrigin:function(){return this.evalOrigin},setEvalOrigin:function(u){if(u instanceof c)this.evalOrigin=u;else if(u instanceof Object)this.evalOrigin=new c(u);else throw new TypeError("Eval Origin must be an Object or StackFrame")},toString:function(){var u=this.getFileName()||"",g=this.getLineNumber()||"",w=this.getColumnNumber()||"",F=this.getFunctionName()||"";return this.getIsEval()?u?"[eval] ("+u+":"+g+":"+w+")":"[eval]:"+g+":"+w:F?F+" ("+u+":"+g+":"+w+")":u+":"+g+":"+w}},c.fromString=p(function(u){var g=u.indexOf("("),w=u.lastIndexOf(")"),F=u.substring(0,g),be=u.substring(g+1,w).split(","),B=u.substring(w+1);if(B.indexOf("@")===0)var C=/@(.+?)(?::(\d+))?(?::(\d+))?$/.exec(B,""),ve=C[1],Fe=C[2],Me=C[3];return new c({functionName:F,args:be||void 0,fileName:ve,lineNumber:Fe||void 0,columnNumber:Me||void 0})},"StackFrame$$fromString");for(var m=0;m<i.length;m++)c.prototype["get"+a(i[m])]=s(i[m]),c.prototype["set"+a(i[m])]=function(u){return function(g){this[u]=!!g}}(i[m]);for(var _=0;_<t.length;_++)c.prototype["get"+a(t[_])]=s(t[_]),c.prototype["set"+a(t[_])]=function(u){return function(g){if(!r(g))throw new TypeError(u+" must be a Number");this[u]=Number(g)}}(t[_]);for(var y=0;y<l.length;y++)c.prototype["get"+a(l[y])]=s(l[y]),c.prototype["set"+a(l[y])]=function(u){return function(g){this[u]=String(g)}}(l[y]);return c})}),Ve=Q((e,n)=>{(function(r,a){typeof define=="function"&&define.amd?define("error-stack-parser",["stackframe"],a):typeof e=="object"?n.exports=a(He()):r.ErrorStackParser=a(r.StackFrame)})(e,p(function(r){var a=/(^|@)\S+:\d+/,s=/^\s*at .*(\S+:\d+|\(native\))/m,i=/^(eval@)?(\[native code])?$/;return{parse:p(function(t){if(typeof t.stacktrace<"u"||typeof t["opera#sourceloc"]<"u")return this.parseOpera(t);if(t.stack&&t.stack.match(s))return this.parseV8OrIE(t);if(t.stack)return this.parseFFOrSafari(t);throw new Error("Cannot parse given Error object")},"ErrorStackParser$$parse"),extractLocation:p(function(t){if(t.indexOf(":")===-1)return[t];var l=/(.+?)(?::(\d+))?(?::(\d+))?$/,o=l.exec(t.replace(/[()]/g,""));return[o[1],o[2]||void 0,o[3]||void 0]},"ErrorStackParser$$extractLocation"),parseV8OrIE:p(function(t){var l=t.stack.split(`
